...
import { Lock, Mail, ShieldAlert, User, ShieldCheck, Sun, Zap } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-center relative pr-12">
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-sm font-['Inter'] text-black/70 font-semibold max-w-sm leading-relaxed mt-4">
            Register to track renewable energy resources, view community projects, and manage sustainability metrics.
          </p>
        </div>
        ...
        <div className="mt-12 flex gap-4 font-['Montserrat']">
          <div className="eco-nexus-glass-card p-4 flex items-center gap-3">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest">Grid Mapping</span>
          </div>
          <div className="eco-nexus-glass-card p-4 flex items-center gap-3">
            <ShieldCheck className="h-5 w-5 text-black" />
            <span className="text-[10px] font-bold uppercase tracking-widest">Clean Energy</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center relative py-12">
        <div className="w-full max-w-md relative z-10">
          <div className="eco-nexus-glass-card p-8 md:p-12 relative overflow-hidden shadow-2xl">
            ...
            <h2 className="font-['Montserrat'] text-4xl font-black uppercase mb-8 mt-2">Sign Up</h2>
            ...
            <form onSubmit={handleSignup} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-white/40 border border-black/10 px-4 py-4 text-sm font-['Montserrat'] font-bold text-black focus:outline-none focus:bg-white/60 transition-colors select-none"
                  >
              ...
              <div className="flex items-center gap-4 bg-white/40 border border-black/10 p-4 cursor-pointer hover:bg-white/60 transition-colors">
                <input
                  id="mfa"
                  type="checkbox"
                  checked={mfaOptIn}
                  onChange={(e) => setMfaOptIn(e.target.checked)}
                  className="h-4 w-4 accent-black cursor-pointer shrink-0"
                />
                <label htmlFor="mfa" className="text-[10px] font-['Montserrat'] font-bold uppercase tracking-widest text-black cursor-pointer flex items-center gap-2 select-none">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-[10px] font-['Montserrat'] font-bold uppercase tracking-widest">
                <span className="bg-[#E1EBED] px-4 text-black/40">OR SIGN UP WITH</span>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-black/10 flex justify-between items-center">
              <p className="text-[10px] font-['Montserrat'] text-black/60 font-bold uppercase tracking-widest">
                ...
                <Link to="/login" className="text-black font-black underline hover:text-[#dfed2b] hover:bg-black px-1 transition-colors">
                  Sign In
                </Link>
              </p>
            </div>
